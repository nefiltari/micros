...
(function() {
  var Micros, async, coffee, decompress, generate_key, generate_router_key, process_inner_chain, register, runtime, _,
    __slice = [].slice;
  ...
  Micros.router.$register = function(req, cb) {
    var key;
    key = generate_router_key(req);
    return register[key] = cb;
  };
